...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_iB().pack(_x.grip, _x.isReady))
      _x = self.state
      length = len(_x)
      ...
      buff.write(_get_struct_B().pack(self.pending))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.grip, _x.isReady,) = _get_struct_iB().unpack(str[start:end])
      ...
      (self.pending,) = _get_struct_B().unpack(str[start:end])
